...
func (s *serviceImpl) scanNamespaceResourcesTableDriven(ctx context.Context, namespace string, includeKinds map[string]struct{}) ([]*importResource, []string, error) {
...
func (s *serviceImpl) buildNamespaceScanSteps(namespace string) []namespaceScanStep {
...
func (s *serviceImpl) scanDeployments(ctx context.Context, namespace string) ([]*importResource, []string, error) {
...
func (s *serviceImpl) scanStatefulSets(ctx context.Context, namespace string) ([]*importResource, []string, error) {
...
func (s *serviceImpl) scanDaemonSets(ctx context.Context, namespace string) ([]*importResource, []string, error) {
...
func (s *serviceImpl) scanJobs(ctx context.Context, namespace string) ([]*importResource, []string, error) {
...
func (s *serviceImpl) scanCronJobs(ctx context.Context, namespace string) ([]*importResource, []string, error) {
...
func (s *serviceImpl) scanConfigMaps(ctx context.Context, namespace string) ([]*importResource, []string, error) {
...
func (s *serviceImpl) scanSecrets(ctx context.Context, namespace string) ([]*importResource, []string, error) {
...
func (s *serviceImpl) scanPVCs(ctx context.Context, namespace string) ([]*importResource, []string, error) {
...
func (s *serviceImpl) scanServices(ctx context.Context, namespace string) ([]*importResource, []string, error) {
...
func (s *serviceImpl) scanIngresses(ctx context.Context, namespace string) ([]*importResource, []string, error) {
...
func (s *serviceImpl) scanServiceAccounts(ctx context.Context, namespace string) ([]*importResource, []string, error) {
...
func (s *serviceImpl) scanRoles(ctx context.Context, namespace string) ([]*importResource, []string, error) {
...
func (s *serviceImpl) scanRoleBindings(ctx context.Context, namespace string) ([]*importResource, []string, error) {
...
func (s *serviceImpl) scanPodDisruptionBudgets(ctx context.Context, namespace string) ([]*importResource, []string, error) {
...
func (s *serviceImpl) scanNetworkPolicies(ctx context.Context, namespace string) ([]*importResource, []string, error) {
...
func (s *serviceImpl) scanAssociatedClusterRBACResources(ctx context.Context, namespace string, includeKinds map[string]struct{}) ([]*importResource, []string, error) {
...
func (s *serviceImpl) scanAssociatedPersistentVolumes(
	ctx context.Context,
	namespace string,
