...
import (
	...
	"github.com/PixelCores/Eruun/pkg/apiserver/domain/service/namespaceimport"
...
type NamespaceImportService = namespaceimport.NamespaceImportService
...
func NewNamespaceImportService() NamespaceImportService {
	return namespaceimport.NewNamespaceImportService()
}
...
func InitServiceBean(programmingLanguageOverrides ...ProgrammingLanguageService) []interface{} {
	...
	importService := NewNamespaceImportService()
