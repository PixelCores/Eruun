...
`
	...
	require.Equal(t, string(config.ShareStrategyDefault), policy.ServiceAccountLabels[config.LabelShareStrategy])
	require.NotNil(t, policy.RoleLabels)
	require.Equal(t, "app-role", policy.RoleLabels[config.LabelShareName])
	require.Equal(t, string(config.ShareStrategyDefault), policy.RoleLabels[config.LabelShareStrategy])
	require.NotNil(t, policy.BindingLabels)
	require.Equal(t, "app-binding", policy.BindingLabels[config.LabelShareName])
	require.Equal(t, string(config.ShareStrategyDefault), policy.BindingLabels[config.LabelShareStrategy])
...
`
	...
	require.Equal(t, string(config.ShareStrategyIgnore), api.Traits.Share.Strategy)
