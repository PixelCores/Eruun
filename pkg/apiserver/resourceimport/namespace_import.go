// Package resourceimport owns the one-time discovery and enrollment of
// Kubernetes resources that already exist in a workspace namespace.
...
type Service interface {
	...
	SubmitScanJob(ctx context.Context, req apisv1.ResourceImportScanJobRequest) (*apisv1.ResourceImportJobAcceptedResponse, error)
	SubmitManageJob(ctx context.Context, req apisv1.ResourceImportManageJobRequest) (*apisv1.ResourceImportJobAcceptedResponse, error)
	GetJob(ctx context.Context, taskID string) (*apisv1.ResourceImportJobResponse, error)
}
...
func (s *serviceImpl) ImportNamespaceResources(ctx context.Context, req apisv1.ImportNamespaceApplicationsRequest) (*apisv1.ImportNamespaceApplicationsResponse, error) {
...
func (s *serviceImpl) importNamespaceResources(
	ctx context.Context,
...
func (s *serviceImpl) TryImportNamespaceResources(ctx context.Context, req apisv1.TryImportNamespaceApplicationsRequest) (*apisv1.TryImportNamespaceApplicationsResponse, error) {
	namespace := strings.TrimSpace(req.Namespace)
	if scope, scoped := access.FromContext(ctx); scoped && namespace != scope.Namespace {
		return nil, bcode.ErrForbidden
	}
...
func (s *serviceImpl) prepareImportPlansForExecution(
	ctx context.Context,
	namespace string,
	plans []importAppPlan,
...
func (s *serviceImpl) mergeCreateComponentsWithExisting(
	ctx context.Context,
	appID string,
	appName string,
	namespace string,
...
func (s *serviceImpl) mergeCreateComponentsWithAllExisting(
	ctx context.Context,
	appID string,
	appName string,
	namespace string,
...
func (s *serviceImpl) scanNamespaceResources(ctx context.Context, namespace string, includeKinds map[string]struct{}) ([]*importResource, []string, error) {
	return s.scanNamespaceResourcesTableDriven(ctx, namespace, includeKinds)
}

func (s *serviceImpl) collectAssociatedClusterRBAC(ctx context.Context, namespace string) (map[string]struct{}, map[string]struct{}, []string, error) {
...
func (s *serviceImpl) markPlanResourcesSkipped(resp *apisv1.ImportNamespaceApplicationsResponse, resultIndex map[string]int, resources []*importResource, err error) {
	if resp == nil {
		return
	}
	errText := ""
...
func (s *serviceImpl) markPlanResourcesWithStatus(
...
func (s *serviceImpl) updatePlanResourceResultAppID(
	resp *apisv1.ImportNamespaceApplicationsResponse,
	resultIndex map[string]int,
	resources []*importResource,
	appID string,
...
func (s *serviceImpl) markPlanResourcesFailed(resp *apisv1.ImportNamespaceApplicationsResponse, resultIndex map[string]int, resources []*importResource, err error) {
	if resp == nil {
		return
	}
	errText := ""
...
func (s *serviceImpl) loadComponentIDMap(ctx context.Context, appID string) (map[string]int, error) {
	if s.ComponentRepo == nil {
		return nil, fmt.Errorf("component repository is nil")
	}
...
func (s *serviceImpl) patchResourceMetadataLabels(ctx context.Context, res *importResource, labels map[string]string) error {
	if res == nil {
		return fmt.Errorf("resource is nil")
	}
	if len(labels) == 0 {
...
func (s *serviceImpl) patchResourceLabelBytes(ctx context.Context, res *importResource, patch []byte) error {
	var err error
	switch res.kindKey {
	case importKindDeployments:
